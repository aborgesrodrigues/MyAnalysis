...
:- use_module(persistence_migration_analysis, [ persistence_call/17 ]).
...
persistence_call(CallId, MethodCall, Receiver, Local, MethodCalled, MethodCalledName, MethodCalledParameters, MethodCalledReturnType, MethodCalledExceptions, CallParameters, DAO, Business, NotBusiness, GenericDAO, 'org.sigaept.edu.dao.EnturmacaoDAO', 'org.sigaept.edu.negocio.ejb.VincularAlunoAClasseEJB', 'org.sigaept.nucleo.dao.GenericDAO') , 
Description = 'Call to DAO', 
make_result_term(persistence_call(CallId, MethodCall, Receiver, Local, MethodCalled, MethodCalledName, MethodCalledParameters, MethodCalledReturnType, MethodCalledExceptions, CallParameters, DAO, Business, NotBusiness, GenericDAO), Description, Result).
...
transformation_api:transformation(
     ...
     persistence_call(CallId, MethodCall, Receiver, Local, MethodCalled, MethodCalledName, MethodCalledParameters, MethodCalledReturnType, MethodCalledExceptions, CallParameters, DAO, Business, NotBusiness, GenericDAO),                 % RoleTerm
     [ 
      addEJBAnnotation(CallId, DAO, Business, NotBusiness, GenericDAO),
      replaceDAOCallforBusinessCall(CallId, Receiver, Local, DAO, Business, NotBusiness, GenericDAO, MethodCall, MethodCalled, MethodCalledName, MethodCalledParameters, MethodCalledReturnType, MethodCalledExceptions, CallParameters),
      replaceVoidDAOCallforVoidusinessCall(CallId, Receiver, Local, DAO, Business, NotBusiness, GenericDAO, MethodCall, MethodCalled, MethodCalledName, MethodCalledParameters, MethodCalledReturnType, MethodCalledExceptions, CallParameters),
      addEJBAnnotationToClass(CallId, DAO, Business, NotBusiness, GenericDAO),
      deleteLocalVariable1(MethodCall, DAO)
      ],         % CTHead
...
transformation_api:transformation(
     ...
     deleteLocalVariable(LocalVariable, MethodCall, Business, NotBusiness),         % CTHead
     'Remove Local Variable',      % Description
     [global, preview]).                               % Option: Show Preview