:- module(persistence_migration_analysis, [ persistence_call/17 ]).
...
persistence_call(CallId, MethodCall, Receiver, Local, MethodCalled, MethodCalledName, MethodCalledParameters, MethodCalledReturnType, MethodCalledExceptions, CallParameters, DAO, Business, NotBusiness, GenericDAO, DAOClass, BusinessClass, GenericDAOClass) :-
...
remove_local_variable(LocalVariable, MethodCall, DAO, Business, NotBusiness, GenericDAO, DAOClass, BusinessClass, GenericDAOClass) :-
